...
JDK_INT32 app_jdk_pixel2_vi_resolution(JDK_UINT32 pixels, JDK_BOOL isNet)
{
	...
	if (isNet) {
		...
		switch (pixels) {
			case 1920*1080:
				ret = JDK_INPUT_BNC_1080P_25;
				break;
			case 960 * 1080:
				ret = JDK_INPUT_BNC_HFHD_25;
				break;
			case 1280 * 720:
				ret = JDK_INPUT_BNC_720P_25;
				break;
			case 960 * 576:
				ret = JDK_INPUT_BNC_960H_25;
				break;
			case 720 * 576:
				ret = JDK_INPUT_BNC_720H_25;
				break;
			case 704 * 576:
			default:
				ret = JDK_INPUT_BNC_D1_25;
				break;
		}
	}
	return ret;
...
static int app_jdk_vin_chn_init(lpJDK_ARG s_jdkCtx)
{
	...
	for ( i = 0; i < JCONF_BNC_CAM(); i++) {
		stJDK_VIN_ARG arg;
		int inmode = JDK_INPUT_FORMAT_AUTO;
		...
		if (inmode == JDK_INPUT_FORMAT_AUTO) {
			...
			switch(channel_mode){
				case VIDEO_MODE_960H:
					inmode = JDK_INPUT_BNC_960H_25;
					break;
				case VIDEO_MODE_720P:
					inmode = JDK_INPUT_BNC_720P_25;
					break;
				case VIDEO_MODE_HALF1080P:
					inmode = JDK_INPUT_BNC_HFHD_25;
					break;
				case VIDEO_MODE_1080P:
					inmode = JDK_INPUT_BNC_1080P_25;
					break;
				default:
...
m_jdkArg.soc = JDK_HI_SOC_3521;
	...
	if(JDK_VSUPPORT_HD1080P == JDK_vin_get_max_support()){
		...
		m_jdkArg.maxBncCamImgResol = JDK_INPUT_BNC_720P_25;
	}
