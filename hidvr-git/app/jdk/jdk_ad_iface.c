...
static JDK_INT32 jdk_def_ad_probe_vi_format(JDK_UINT32 chn)
{
	...
	printf("\n %d : %s \n", chn, HDDVR_GetCHNLType(chn));

	switch(tmpVideoStds) {
		case HDVIDEO_SD720H25FPS:
		case HDVIDEO_SD960H25FPS:
			tmpStdCheck = JDK_INPUT_BNC_960H_25;
			break;
		case HDVIDEO_SD720H30FPS:
		case HDVIDEO_SD960H30FPS:
			tmpStdCheck = JDK_INPUT_BNC_960H_30;
			break;
		case HDVIDEO_HD720P25FPS:
			tmpStdCheck = JDK_INPUT_BNC_720P_25;
			break;
		case HDVIDEO_HD720P30FPS:
			tmpStdCheck = JDK_INPUT_BNC_720P_30;
			break;
		case HDVIDEO_HD720P50FPS:
			tmpStdCheck = JDK_INPUT_BNC_720P_50;
			break;
		case HDVIDEO_HD720P60FPS:
			tmpStdCheck = JDK_INPUT_BNC_720P_60;
			break;
		case HDVIDEO_HD1080P25FPS:
			tmpStdCheck = JDK_INPUT_BNC_HFHD_25;
			break;
		case HDVIDEO_HD1080P30FPS:
			tmpStdCheck = JDK_INPUT_BNC_HFHD_30;
			break;
		default:
		case HDVIDEO_UNKNOWN:
			tmpStdCheck = JDK_INPUT_FORMAT_UNKNOWN;
			break;
	}
